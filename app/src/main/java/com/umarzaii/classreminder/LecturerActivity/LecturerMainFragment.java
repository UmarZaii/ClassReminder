...
public class LecturerMainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.lecturer_fragm_main,container,false);
        return view;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        btnTimeTable.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentHandler.stackFragment(new LecturerTimeFrameDayFragment(),bundle,"TimeFrameDay");
            }
        });
        ...
        btnMyQRCode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                fragmentHandler.stackFragment(new LecturerMyQRCodeFragment(),"MyQRCode");
            }
        });
