...
public class DeptHeadTimeFrameDayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.depthead_fragm_timeframeday,container,false);
        return view;
    }
            ...
            protected void populateViewHolder(TimeFrameDayViewHolder viewHolder, TimeFrameModel model, int position) {
                ...
                viewHolder.fView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        fragmentHandler.stackFragment(new DeptHeadTimeFrameHourFragment(),bundle,"TimeFrameHour");
                    }
                });
