...
public class DatabaseHandler {
    ...
    public DatabaseReference getTblUserCredentialsUserClassID(String userID) {
        return databaseReference.child(tblUser).child(userID).child(credentials).child(userClassID);
    }
