...
import com.umarzaii.classreminder.DeptAdminActivity.DeptAdminAddTimeFrameFragment;
...
public class StudentTimeFrameHourFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.student_fragm_timeframehour,container,false);
        return view;
    }
            ...
            protected void populateViewHolder(TimeFrameHourViewHolder viewHolder, TimeFrameModel model, int position) {
                ...
                viewHolder.fView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        fragmentHandler.stackFragment(new StudentTimeFrameDetailsFragment(),bundle,"TimeFrameDetails");
                    }
                });
